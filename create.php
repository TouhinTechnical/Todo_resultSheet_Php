<?php
    ...
    if(isset($_POST['submit'])=='submit'){
        ...
        $grades = $_POST['grades'];
        $rank = $_POST['rank'];
        $create_query = "INSERT INTO result (id,name,english,math,physics,history,art,highest,lowest,total,average,grades,rank) VALUES ('$id','$name','$english','$math','$physics','$history','$art','$highest','$lowest','$total','$average','$grades','$rank')";
                ...
                <?php
                    ...
                    ?>
                        <form action="#" method="post" class="result_form">
                            ...
                            <button type="submit" name="submit" id="submit" class="from_btn">Submit</button>
                        </form>
                    <?php
                    }
                ?>
